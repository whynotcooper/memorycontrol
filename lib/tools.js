...
export function registerTools(ctx, api) {
  ...
  if (skipped.length > 0) {
    console.warn(`[memorycontrol] memory_* tools already provided by this deployment, skipped re-registering: ${skipped.join(", ")}`);
  }

  // --- context management tools (memorycontrol v0.2) ---
