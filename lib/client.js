/**
 * memorycontrol — browser half (web only).
 *
 ...
 * POST /plugins/memorycontrol/api (see lib/web.js).
 *
  ...
  window.__ModuleLoader__.load({
    ...
    factory: function (require) {
      ...
      function api(op, args, sessionId) {
        return fetch("/plugins/memorycontrol/api", {
          method: "POST",
      ...
      exports.apply = function (ctx) {
        ctx.effect(function () { return ctx.locale.register(NS, dicts); }, "memorycontrol: dictionaries");
